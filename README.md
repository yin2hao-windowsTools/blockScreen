...
7. 快捷键默认未设置，可在管理窗口中自行设置并保存。
8. 如果快捷键与其他程序冲突，可在管理窗口中更换或清空。
...
- 便携 ZIP：解压后运行根目录的 `blockScreen.exe`，请保持 `blockScreen.exe` 和 `app` 文件夹完整。
...
本项目使用 MIT License。完整许可证文本请查看 [LICENSE](LICENSE)。
